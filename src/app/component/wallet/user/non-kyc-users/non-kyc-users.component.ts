...
@Component({
  selector: 'app-non-kyc-users',
  templateUrl: './non-kyc-users.component.html',
  styleUrls: ['./non-kyc-users.component.css'],
  animations: [
...
export class NonKycUsersComponent implements OnInit {
...
this.testCount=1;
  ...
  this.users=[ {id:3}];
    ...
    this.jobService.getNonKYCUsers()
      .subscribe( data => {
